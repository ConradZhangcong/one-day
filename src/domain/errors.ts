export const DomainErrorCode = {
  ...
  INVALID_RECURRENCE_RANGE: 'INVALID_RECURRENCE_RANGE',
  RECURRENCE_LIMIT_EXCEEDED: 'RECURRENCE_LIMIT_EXCEEDED',
  RECURRENCE_ANCHOR_MISSING: 'RECURRENCE_ANCHOR_MISSING',
  RECURRENCE_SERIES_NOT_FOUND: 'RECURRENCE_SERIES_NOT_FOUND',
  RECURRENCE_SERIES_STATE_INVALID: 'RECURRENCE_SERIES_STATE_INVALID',
  OCCURRENCE_NOT_ACTIVE: 'OCCURRENCE_NOT_ACTIVE',
  ...
  BACKUP_INVALID_FORMAT: 'BACKUP_INVALID_FORMAT',
  BACKUP_UNSUPPORTED_VERSION: 'BACKUP_UNSUPPORTED_VERSION',
  BACKUP_INVALID_DATA: 'BACKUP_INVALID_DATA',
} as const;
