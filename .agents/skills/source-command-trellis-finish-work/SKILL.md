---
name: "source-command-trellis-finish-work"
description: "Migrated source command `trellis-finish-work`"
---

# source-command-trellis-finish-work

Use this skill when the user asks to run the migrated source command `trellis-finish-work`.
