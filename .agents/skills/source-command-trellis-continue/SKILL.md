---
name: "source-command-trellis-continue"
description: "Migrated source command `trellis-continue`"
---

# source-command-trellis-continue

Use this skill when the user asks to run the migrated source command `trellis-continue`.
