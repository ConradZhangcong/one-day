...
graph TD
    ...
    subgraph "状态管理层 (State Layer)"
        ...
        B2[ProjectStore<br/>计划状态]
        B3[JournalStore<br/>日记状态]
        B4[SettingsStore<br/>设置状态]
        B5[UIStore<br/>UI状态]
    end
    
    subgraph "业务逻辑层 (Business Layer)"
        C1[TaskService<br/>任务服务]
        C2[ProjectService<br/>计划服务]
        C3[JournalService<br/>日记服务]
        C4[SyncService<br/>同步服务]
        C5[AIService<br/>AI服务]
    end
    
    subgraph "数据访问层 (Data Access Layer)"
        D1[TaskRepository<br/>任务仓库]
        D2[ProjectRepository<br/>计划仓库]
        D3[JournalRepository<br/>日记仓库]
        D4[Database<br/>Dexie实例]
    end
...
graph TD
    ...
    Components --> Project[project/<br/>计划组件]
    ...
    Pages --> ProjectPage[Project/<br/>计划页]
...
flowchart TD
    ...
    ChooseAction -->|管理计划| ProjectFlow[计划管理流程]
    ...
    ProjectFlow --> ListProjects[显示计划列表]
    ListProjects --> ProjectAction{计划操作}
    ProjectAction -->|创建计划| CreateProject[创建新计划]
    ProjectAction -->|查看进度| ViewProgress[查看计划进度]
    ProjectAction -->|关联任务| LinkTasks[关联任务到计划]
    ...
    CreateProject --> MainView
    ViewProgress --> MainView
    LinkTasks --> MainView
